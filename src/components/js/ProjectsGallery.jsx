...
function ProjectsGallery({ PROJECTS }) {
	...
	return (
		<div className="grid gap-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
			{/* Columna 1 */}
			<div className="grid justify-center gap-4" id="column1">
			...
			{/* Columna 2 */}
			<div className="grid justify-center gap-4" id="column2">
			...
			{/* Columna 3 */}
			<div className="grid justify-center gap-4" id="column3">
